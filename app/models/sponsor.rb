...
class Sponsor < ActiveRecord::Base
  ...
  extend Enumerize
  enumerize :category, in: ["Title Sponsor","Associate Sponsor","Category Sponsor","Event Partner","Food and Beverages Partner","Media Partner","Hackathon Partner","Workshop Partner","Partner"]
